...
echo "=== SINCRONIZANDO DESDE BODEGA LIB ===\n\n";
...
foreach ($productos as $codigo) {
    echo "🔍 SINCRONIZANDO: $codigo desde bodega LIB\n";
    echo str_repeat("=", 50) . "\n";
    
    // Consulta específica para bodega LIB
    $query = "
        SELECT 
        ...
        FROM MAEPR
        LEFT JOIN MAEST ON MAEPR.KOPR = MAEST.KOPR AND MAEST.KOBO = 'LIB' AND MAEST.EMPRESA = '01'
    ...
    echo "Consulta SQL Server (Bodega LIB):\n";
    echo $output . "\n";
    ...
    if ($productoData) {
        ...
        if ($producto) {
            ...
            echo "\n✅ PRODUCTO ACTUALIZADO EN MYSQL CON DATOS DE BODEGA LIB\n";
        } else {
