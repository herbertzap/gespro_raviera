...
class ManejoStockController extends Controller
{
    ...
    public function historial(Request $request)
    {
        ...
        if ($usuario) {
            ...
            $capturasQuery->where('funcionario', $user->codigo_vendedor ?? 'PZZ');
        }
    ...
    public function reporte(Request $request)
    {
        try {
            ...
            // Primero hacer JOIN con MAEDDO (que es donde están los datos)
            // Luego LEFT JOIN con MAEEDOOB para obtener la observación si existe
            // Filtrar solo documentos que tengan la observación "Documento GESTPRO"
            $query = "
                SELECT 
                    MAEEDO.IDMAEEDO,
                    MAEEDO.TIDO,
