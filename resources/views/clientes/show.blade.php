                    ...
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                ...
                                <a href="{{ route('cliente.imprimir', $cliente->codigo_cliente) }}" class="btn btn-danger">
                                    <i class="material-icons">picture_as_pdf</i> Imprimir Ficha
                                </a>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="chequesCartera-tab" data-toggle="tab" href="#chequesCartera" role="tab">
                                    <i class="material-icons">account_balance</i> Cheques en Cartera
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="chequesProtestados-tab" data-toggle="tab" href="#chequesProtestados" role="tab">
