        ...
        <div class="card">
            ...
            <div class="card-body">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="chequesCartera-tab-info" data-toggle="tab" href="#chequesCarteraInfo" role="tab">
                            <i class="material-icons">account_balance</i> Cheques en Cartera
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="chequesProtestados-tab-info" data-toggle="tab" href="#chequesProtestadosInfo" role="tab">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="chequesCarteraInfo" role="tabpanel">
                    ...
                    <div class="tab-pane fade" id="chequesProtestadosInfo" role="tabpanel">
                        <div class="table-responsive mt-3">
                            <table class="table">
