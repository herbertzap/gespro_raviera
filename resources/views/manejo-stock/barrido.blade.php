                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="card-title mb-0">
                            <i class="tim-icons icon-tablet-2"></i> Aplicación de Barrido
                        </h4>
                        <div>
                            <small>
                    ...
                    <div>
                        <a href="{{ route('manejo-stock.reporte-inventario') }}" class="btn btn-info btn-sm">
                            <i class="tim-icons icon-chart-bar-32"></i> Reporte
                        </a>
                        <a href="{{ route('manejo-stock.barrido.select') }}" class="btn btn-primary">Cambiar Bodega</a>
                    </div>
                </div>
                <div class="card-body">
                    @if (session('status'))
                    ...
                    <div id="productoDetalle" class="card mt-4" style="display: none;">
                        <div class="card-header bg-info">
                            <h5 class="mb-0 text-white">Detalle del producto - Barrido</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mt-3">
                                        <button type="button" id="btnGuardarCaptura" class="btn btn-info btn-block" disabled>
                                            <i class="tim-icons icon-check-2"></i> Registrar Barrido
                                        </button>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal-content">
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title" id="modalExitoGuardadoLabel">
                    <i class="tim-icons icon-check-2"></i> Barrido Registrado
                </h5>
            ...
            <div class="modal-body">
                <div class="text-center">
                    <i class="tim-icons icon-check-2 text-info" style="font-size: 3rem;"></i>
                    <h5 class="mt-3 text-white">Producto registrado en TINVENTARIO</h5>
                    <p class="mb-2 text-white"><strong>Producto:</strong> <span id="modalExitoProducto"></span></p>
                    <p class="mb-0 text-white"><strong>Cantidad:</strong> <span id="modalExitoCantidad"></span></p>
                </div>
            </div>
            <div class="modal-footer">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const guardarCapturaUrl = "{{ route('manejo-stock.barrido.guardar') }}";
        ...
        // Funcionalidad de guardar captura (BARRIDO - solo INSERT a TINVENTARIO)
        btnGuardarCaptura.addEventListener('click', () => {
            ...
            formData.append('codigo_barras', productoActual.barcode_actual || productoActual.barcode || '');
            ...
            formData.append('cantidad', captura1); // Campo correcto para el controlador
            ...
            .then(data => {
                if (data && data.success) {
                    ...
                    btnGuardarCaptura.innerHTML = '<i class="tim-icons icon-check-2"></i> Registrar Barrido';
                } else {
            ...
            .catch(error => {
                ...
                alert('Error al guardar el barrido: ' + (error.message || 'Intente nuevamente.'));
                btnGuardarCaptura.disabled = false;
                btnGuardarCaptura.innerHTML = '<i class="tim-icons icon-check-2"></i> Registrar Barrido';
            });
        });
        ...
        if (ubicacionId) {
            ...
            console.log('Para habilitar el botón "Registrar Barrido", necesitas:');
