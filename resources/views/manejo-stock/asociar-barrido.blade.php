        ...
        <div class="col-md-10 offset-md-1">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="card-title mb-0">Asociar código de barras - Barrido</h4>
                        <small>
                ...
                <div class="card-body">
                    <div class="alert alert-info">
                        ...
                        El código escaneado no existe. Selecciona el producto correcto para asociarlo. Si el producto ya tiene un código, será reemplazado automáticamente.
                    </div>
                    ...
                    <form id="formAsociar" method="POST" action="{{ route('manejo-stock.asociar-barrido.store') }}">
                        @csrf
                        ...
                        <input type="hidden" name="accion_codigo" id="inputAccionCodigo" value="replace">
                        ...
                        <div class="card-body">
                            ...
                            <div id="estadoCodigoActual" class="alert alert-warning" style="display: none;">
                                ...
                                <p class="mb-0 text-info">
                                    ...
                                    El código actual será reemplazado automáticamente por el nuevo código escaneado.
                                </p>
                            </div>
                            <div class="text-right">
                                <button class="btn btn-success" type="submit" form="formAsociar" id="btnGuardarAsociacion" disabled>Asociar y Reemplazar</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        function cargarDetalleProducto(sku) {
            fetch(`${productoDetalleUrl}?sku=${encodeURIComponent(sku)}&bodega_id=${bodegaId}`)
                ...
                .then(data => {
                    ...
                    // Siempre usar replace para barrido simplificado
                    ...
                    if (producto.barcode_actual) {
                        ...
                        btnGuardar.textContent = 'Reemplazar código';
                    } else {
                        estadoCodigoActual.style.display = 'none';
                        inputExistingBarcode.value = '';
                        btnGuardar.textContent = 'Asociar código';
                    }
                })
                .catch(error => {
