-- Script para crear las vistas de NVV Pendientes y Facturas Pendientes
-- Ejecutar este script en SQL Server Management Studio o usando tsql

PRINT 'Creando vista vw_nvv_pendientes_detalle...'
GO
...
PRINT 'Vista vw_nvv_pendientes_detalle creada exitosamente'
GO

PRINT 'Creando vista vw_facturas_pendientes...'
GO
...
PRINT 'Vista vw_facturas_pendientes creada exitosamente'
GO

-- Verificar que las vistas se crearon correctamente
PRINT 'Verificando vista vw_nvv_pendientes_detalle...'
SELECT TOP 3 * FROM vw_nvv_pendientes_detalle WHERE KOFU = 'GOP'
GO

PRINT 'Verificando vista vw_facturas_pendientes...'
