-- =============================================
-- Script para crear vistas del Dashboard del Vendedor
...
PRINT '- vw_nvv_pendientes_detalle'
PRINT '- vw_facturas_pendientes'
PRINT ''
PRINT 'Ahora puedes acceder al dashboard del vendedor en la aplicación web.'
